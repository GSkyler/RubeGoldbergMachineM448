...
class BouncyBalls(object):
    ...
    def _add_static_scenery(self):#draws the line
        ...
        static_lines = [pymunk.Segment(static_body, (55.0, 100.0), (55.0, 600.0), 0.0),
                        pymunk.Segment(static_body, (450.0, 100.0), (450.0, 600.0), 0.0)
                        ]
        ...
        for y in range(5):
            for x in range(5):
                if (y%2==0):
                    ...
                    if (x<4):
                        b = pymunk.Body(body_type=pymunk.Body.STATIC)
                        b.position = (75 + (x*90)+40, 200+(y*70))
                        s = pymunk.Circle(b, 2)
                        s.elasticity = 0.3
                        self._space.add(s)
