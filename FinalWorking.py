...
class BouncyBalls(object):
   ...
   def __init__(self):
       ...
       self._clear_screen()
       self._space.remove(self._space.bodies)
       self._space.remove(self._space.shapes)
   ...
   def _add_static_scenery(self):#draws the line
       ...
       static_lines = [pymunk.Segment(static_body, (0.0, 300.0), (0.0, 600.0), 0.0),  # Left border
                       ...
                       pymunk.Segment(static_body, (1365.0, 115.0), (1385.0, 40.0), 0.0),  # bucket1 left
                       pymunk.Segment(static_body, (1555.0, 115.0), (1535.0, 40.0), 0.0),  # bucket1 right
                       pymunk.Segment(static_body, (1385.0, 40.0), (1535.0, 40.0), 0.0),   # bucket1 bottom

                       pymunk.Segment(static_body, (1555.0, 115.0), (1575.0, 40.0), 0.0),  # bucket2 left
                       pymunk.Segment(static_body, (1745.0, 115.0), (1725.0, 40.0), 0.0),  # bucket2 right
                       pymunk.Segment(static_body, (1575.0, 40.0), (1725.0, 40.0), 0.0),  # bucket2 bottom
   ...
   def _add_fan(self):
       points = [(-100, -5), (-100, 5), (75, 5), (75, -5)]
       body = pymunk.Body(body_type=pymunk.Body.STATIC)
       body.position = 1250, 300
       shape = pymunk.Poly(body, points, None, 0)
       shape.elasticity = 0
       shape.friction = 0
       self._space.add(body, shape)
